...
const option_ViettelPay = GenericTemplate([
    ...
    "Tải và đăng kí tài khoản ViettelPay để nhận được những ưu đãi hấp dẫn nhé!", [
        ButtonURL("Tải ViettelPay Android", "https://shorten.asia/xc5QyMtz"),
        ButtonURL("Tải ViettelPay IOS", "https://shorten.asia/d7Yv8KTA"),
        ButtonURL("Video hướng dẫn", "https://youtu.be/7OqK5G1O9e0")
    ])
])
